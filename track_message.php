...
// Setting up the cookie function
$user_first_time = isset( $_COOKIE["UserFirstTime"]);
setcookie( "UserFirstTime", 1, strtotime( '+1 year' ), COOKIEPATH, COOKIE_DOMAIN);
// Cheking if is user first time
if( !$user_first_time ){
    new TrackMessage();
        }
